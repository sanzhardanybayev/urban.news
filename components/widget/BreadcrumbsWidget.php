...
class BreadcrumbsWidget extends Widget
{
   ...
   */
  public $options = ['class' => 'light-blue breadcrumbs z-depth-1'];
  /**
   ...
   */
  public $activeItemTemplate = "<a class=\"breadcrumb active\" href='#'>{link}</a>\n";
  ...
  public function run()
  {
    ...
    // Customizing for the sake of Materialize.css
    array_unshift($links,"<div class='col row s12'>");
    array_unshift($links,"<div class='nav-wrapper container'>");
  ...
  protected function renderItem($link, $template)
  {
    ...
    if (isset($link['url'])) {
      ...
      $link = Html::a($label, $link['url'], ['class' => 'breadcrumb']);
    } else {
      $link = $label;
    }
