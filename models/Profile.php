 ...
 */
class Profile extends ActiveRecord implements ProfileEventsInterface
{
    use ModuleTrait;
    ...
    public function onNameChange($event){
      $event_id = Yii::$app->utility->returnEventIdByEventName($event->event_name);

      $eventTrigger = new EventTrigger($event_id, 'Обновление профиля', null , $event->event_type, $event->username, $event->user_id, null);

      $modelNotification = new ModelNotification();
      $modelNotification->notifyViaEmailOrBrowser($eventTrigger);
    }

    public function onBioChange($event){
      $event_id = Yii::$app->utility->returnEventIdByEventName($event->event_name);
    ...
    public function onWebsiteChange($event){
      $event_id = Yii::$app->utility->returnEventIdByEventName($event->event_name);
    ...
    public function onPublicEmailChange($event){
      $event_id = Yii::$app->utility->returnEventIdByEventName($event->event_name);
    ...
    public function onAvatarChange($event){
      $event_id = Yii::$app->utility->returnEventIdByEventName($event->event_name);
