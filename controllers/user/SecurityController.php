...
class SecurityController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'rules' => [
                    ['allow' => true, 'actions' => ['login', 'testlogin', 'auth', 'blocked'], 'roles' => ['?']],
  ...
  /**
   * @return string|Response
   * This function is made only for the sake of test. Reason - click method of FunctionalTester class does not recognize
   * UTF-8. What this function does is simply substitute key russian words with their english equivalents
   */
